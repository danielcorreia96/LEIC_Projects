...
public:
  virtual void do_function_def_node(xpl::function_def_node * const node, int lvl) = 0;
...
public:
  ...
  virtual void do_mem_address_node(xpl::mem_address_node * const  node, int lvl) = 0;
  virtual void do_indexing_node(xpl::indexing_node * const  node, int lvl) = 0;
  virtual void do_identity_node(xpl::identity_node * const  node, int lvl) = 0;
  virtual void do_println_node(xpl::println_node * const  node, int lvl) = 0;
  virtual void do_function_decl_node(xpl::function_decl_node * const  node, int lvl) = 0;
  virtual void do_variable_decl_node(xpl::variable_decl_node * const  node, int lvl) = 0;
  ...
  //virtual void do_template_node(xpl::template_node * const  node, int lvl) = 0;
