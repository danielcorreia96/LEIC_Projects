...
public class GetProductIT extends BaseIT {
	...
	// attack simulation for product id "HARAMBE"
	@Test(expected = RuntimeException.class)
	public void attackHarambeTest() throws BadProductId_Exception, BadProduct_Exception {
		// aditional setup
		ProductView product = new ProductView();
		product.setId("HARAMBE");
		product.setDesc("Basketball");
		product.setPrice(10);
		product.setQuantity(10);
		client.createProduct(product);
		
		product = client.getProduct("HARAMBE");		
	}
