...
public class SupplierClient implements SupplierPortType {
	...
	public SupplierClient(String uddiURL,String serviceName) throws SupplierClientException {
		...
		uddiLookup();
		createStub();
		KomparatorSecurityManager.setName("A52_Mediator");
    ...
    private void uddiLookup() throws SupplierClientException {
        try {
            ...
            if (verbose)
                System.out.printf("Looking for '%s'%n", this.serviceName);
            wsURL = uddiNaming.lookup(this.serviceName);
        ...
        if (wsURL == null) {
            String msg = String.format(
                    "Service with name %s not found on UDDI at %s", this.serviceName,
                    uddiURL);
