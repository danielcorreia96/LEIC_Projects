...
public class MediatorEndpointManager {
	...
	public void start() throws Exception {
		...
		if (!wsURL.contains("8072")){
			publishToUDDI();
			System.out.println("I am the primary Mediator server");
			primary=true;
		}
		else{
			System.out.println("I am the backup Mediator server");
		}
		KomparatorSecurityManager.setName(this.wsName);
