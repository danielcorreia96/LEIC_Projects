...
(print "Exercise 2.2 CORTE LIM 2 - limdepthfirstsearch")
(format t "~% Solution is correct? ~a" (equal (limdepthfirstsearch *p1* 2) ':corte))

(print "Exercise 2.2 CORTE LIM 4 - limdepthfirstsearch")
(format t "~% Solution is correct? ~a" (equal (limdepthfirstsearch *p1* 4) ':corte))
...
(print "Exercise 2.2b CORTE LIM 2 - limdepthfirstsearch")
(format t "~% Solution is correct? ~a" (equal (limdepthfirstsearch *p1* 2) ':corte))

(print "Exercise 2.2b CORTE LIM 3 - limdepthfirstsearch")
(format t "~% Solution is correct? ~a" (equal (limdepthfirstsearch *p1* 3) ':corte))
